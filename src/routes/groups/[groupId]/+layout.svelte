...
<div class="space-y-4">
	<div>
		<h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{data.group.name}</h1>
		{#if data.group.description}
			<p class="text-sm text-gray-500 dark:text-gray-400">{data.group.description}</p>
		{/if}
	</div>
