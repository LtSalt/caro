...
<div class="space-y-6">
	...
	{#if groups.length === 0}
		<div class="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center dark:border-gray-700">
			<p class="text-gray-500 dark:text-gray-400">No groups yet. Create one to start splitting expenses.</p>
		</div>
	{:else}
			...
			{#each groups as group}
				...
				>
					<div class="flex items-start justify-between">
						<div>
							<h2 class="font-semibold text-gray-900 dark:text-gray-100">{group.name}</h2>
